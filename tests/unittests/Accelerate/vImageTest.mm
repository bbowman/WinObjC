...
uint8_t input[10][10][4] = { { { 232, 19, 158, 38 },
                               { 175, 197, 114, 68 },
                               { 188, 109, 120, 80 },
                               { 102, 47, 102, 143 },
                               { 142, 79, 160, 52 },
...
TEST(Accelerate, BoxConvolve) {
    ...
    uint8_t kvICiP_Expected[10][10][4] = { { { 232, 19, 158, 38 },
                                             { 175, 197, 114, 68 },
                                             { 188, 109, 120, 80 },
                                             { 102, 47, 102, 143 },
                                             { 142, 79, 160, 52 },
    ...
    for (int i = 0; i < 10; ++i) {
        for (int j = 0; j < 10; ++j) {
            for (int k = 0; k < 4; ++k) {
                ASSERT_NEAR_MSG(kvICiP_Expected[i][j][k],
                                res[i * 40 + j * 4 + k],
                                2,
    ...
    uint8_t kvIEE_Expected[10][10][4] = { { { 143, 94, 154, 75 },
                                            { 135, 100, 144, 84 },
                                            { 126, 111, 134, 90 },
                                            { 106, 126, 115, 89 },
                                            { 101, 107, 123, 99 },
    ...
    for (int i = 0; i < 10; ++i) {
        for (int j = 0; j < 10; ++j) {
            for (int k = 0; k < 4; ++k) {
                ASSERT_NEAR_MSG(kvIEE_Expected[i][j][k],
                                res[i * 40 + j * 4 + k],
                                2,
    ...
    uint8_t kvITC_Expected[10][10][4] = { { { 99, 134, 138, 87 },
                                            { 103, 125, 141, 91 },
                                            { 99, 124, 136, 99 },
                                            { 96, 137, 110, 98 },
                                            { 101, 128, 113, 108 },
    ...
    for (int i = 0; i < 10; ++i) {
        for (int j = 0; j < 10; ++j) {
            for (int k = 0; k < 4; ++k) {
                ASSERT_NEAR_MSG(kvITC_Expected[i][j][k],
                                res[i * 40 + j * 4 + k],
                                2,
    ...
    uint8_t kvICBCF_Expected[10][10][4] = { { { 42, 61, 69, 57 },
                                              { 55, 71, 83, 64 },
                                              { 63, 82, 93, 76 },
                                              { 62, 90, 78, 75 },
                                              { 65, 85, 80, 81 },
    ...
    for (int i = 0; i < 10; ++i) {
        for (int j = 0; j < 10; ++j) {
            for (int k = 0; k < 4; ++k) {
                ASSERT_NEAR_MSG(kvICBCF_Expected[i][j][k],
                                res[i * 40 + j * 4 + k],
                                2,
    ...
    uint8_t Copy[6][6][4] = { { { 116, 125, 134, 113 },
                                { 108, 140, 124, 103 },
                                { 101, 130, 124, 107 },
                                { 118, 133, 123, 113 },
                                { 111, 140, 125, 103 },
    ...
    uint8_t EE[6][6][4] = { { { 116, 125, 134, 113 },
                              { 108, 140, 124, 103 },
                              { 101, 130, 124, 107 },
                              { 118, 133, 123, 113 },
                              { 111, 140, 125, 103 },
    ...
    uint8_t TK[6][6][4] = { { { 116, 125, 134, 113 },
                              { 108, 140, 124, 103 },
                              { 101, 130, 124, 107 },
                              { 118, 133, 123, 113 },
                              { 111, 140, 125, 103 },
    ...
    uint8_t BCF[6][6][4] = { { { 116, 125, 134, 113 },
                               { 108, 140, 124, 103 },
                               { 101, 130, 124, 107 },
                               { 118, 133, 123, 113 },
                               { 111, 140, 125, 103 },
...
TEST(Accelerate, MatrixMultiply) {
    ...
    int16_t A[] = { 149, 124, 116, 114, 174, 190, 18, 191, 80, 128, 65, 44, 3, 70, 168, 188 };

    double meandivisor = 400;

    g_error = vImageMatrixMultiply_ARGB8888(&src, &dest, A, meandivisor, NULL, NULL, 0);

    uint8_t matMultExpected[10][10][4] = { { { 127, 138, 110, 110 },
                                             { 174, 196, 107, 188 },
                                             { 142, 162, 113, 156 },
                                             { 80, 112, 108, 130 },
                                             { 120, 142, 93, 120 },
    ...
    int16_t B[] = { 192, 152, 16, 22, 95, 97, 149, 70, 186, 162, 21, 69, 58, 77, 187, 119 };

    g_error = vImageMatrixMultiply_ARGB8888(&src, &dest, B, meandivisor / 2, NULL, NULL, 0);

    uint8_t matMultExpected2[10][10][4] = { { { 255, 255, 85, 109 },
                                              { 255, 255, 236, 168 },
                                              { 255, 255, 184, 148 },
                                              { 255, 238, 188, 148 },
                                              { 255, 255, 136, 129 },
